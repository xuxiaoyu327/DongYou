 ...
 * 修改前必须备份！改完立即测试！
 *************************/
// Coze API 配置（鉴权核心，改值前确认新Token/BotId有效）
...
/************************* 
 * ⚠️ 核心API请求逻辑 - 禁止修改 ⚠️
 * 唯一可改：errorMessage文案、formatMessage里的Markdown规则
 *************************/
// 发送消息到 Coze API
...
/************************* 
 * 业务逻辑函数（可修改交互逻辑，勿改核心调用）
 *************************/
// 发送消息（可改UI交互，勿改API调用流程）
